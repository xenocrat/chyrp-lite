<?php
    ...
    function sanitize(
        ...
        $utf8mb = array(
            ...
            chr(208).chr(163) => 'U', // У
            chr(208).chr(164) => 'F', // Ф
            chr(208).chr(165) => 'Kh', // Х
            chr(208).chr(166) => 'Ts', // Ц
            chr(208).chr(167) => 'Ch', // Ч
            chr(208).chr(168) => 'Sh', // Ш
            chr(208).chr(169) => 'Sch', // Щ
            chr(208).chr(170) => '',   // Ъ
            chr(208).chr(171) => 'Y',  // Ы
            chr(208).chr(172) => '',   // Ь
            chr(208).chr(173) => 'E',  // Э
            chr(208).chr(174) => 'Yu', // Ю
            chr(208).chr(175) => 'Ya', // Я
            chr(208).chr(176) => 'a', // а
            chr(208).chr(177) => 'b', // б
            chr(208).chr(178) => 'v', // в
            chr(208).chr(179) => 'g', // г
            ...
            chr(209).chr(131) => 'u', // у
            chr(209).chr(132) => 'f', // ф
            chr(209).chr(133) => 'kh', // х
            chr(209).chr(134) => 'ts', // ц
            chr(209).chr(135) => 'ch', // ч
            chr(209).chr(136) => 'sh', // ш
            chr(209).chr(137) => 'sch', // щ
            chr(209).chr(138) => '',    // ъ
            chr(209).chr(139) => 'y',   // ы
            chr(209).chr(140) => '',    // ь
            chr(209).chr(141) => 'e',   // э
            chr(209).chr(142) => 'yu',  // ю
            chr(209).chr(143) => 'ya',  // я
