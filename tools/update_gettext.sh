...
ruby ./tools/gettext.rb ./modules/markdown_lib/ --domain=markdown_lib > ./modules/markdown_lib/locale/en_US.pot
ruby ./tools/gettext.rb ./modules/textile_lib/  --domain=textile_lib  > ./modules/textile_lib/locale/en_US.pot
