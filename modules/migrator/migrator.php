    ...
    class Migrator extends Modules {
        ...
        public function admin_import_wordpress() {
            ...
            if (!$xml or !(substr_count($xml->channel->generator, "wordpress.org") or
                ...
                Flash::warning(__("The file does not seem to be a valid WordPress export file.", "migrator"), "/?action=import");
            ...
            Flash::notice(__("WordPress content successfully imported!", "migrator"), "/?action=import");
        }
        ...
        public function admin_import_tumblr() {
            ...
            if (!isset($xml->tumblelog))
                Flash::warning(__("Could not retrieve content from the Tumblr URL. ", "migrator"), "/?action=import");
            ...
            Flash::notice(__("Tumblr content successfully imported!", "migrator"), "/?action=import");
        }
        ...
        public function admin_import_textpattern() {
            ...
            if ($mysqli->connect_errno)
                Flash::warning(__("Could not connect to the TextPattern database.", "migrator"), "/?action=import");
            ...
            Flash::notice(__("TextPattern content successfully imported!", "migrator"), "/?action=import");
        }
        ...
        public function admin_import_movabletype() {
            ...
            if ($mysqli->connect_errno)
                Flash::warning(__("Could not connect to the MovableType database.", "migrator"), "/?action=import");
            ...
            Flash::notice(__("MovableType content successfully imported!", "migrator"), "/?action=import");
        }
    }
